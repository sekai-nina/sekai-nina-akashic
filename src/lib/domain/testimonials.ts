...
重要: 入力の各ブロック [N] に対して、必ず1つの結果をindex=Nとして返してください。スキップしないでください。`;
      ...
      results: {
        ...
        items: {
          ...
          properties: {
            ...
            category: { type: "string", enum: ["personality", "dance", "appearance", "habit", "preference", "skill", "relationship", "other"] },
